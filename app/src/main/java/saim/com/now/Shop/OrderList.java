...
public class OrderList extends AppCompatActivity {
    ...
    public void init(){
        ...
        OrderList(new SharedPrefDatabase(getApplicationContext()).RetriveUserID());
    }



    public void OrderList(final String order_user_id){
        progressBar.setVisibility(View.VISIBLE);
        orderListArrayList.clear();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiURL.Service_Shop_Order_List,
