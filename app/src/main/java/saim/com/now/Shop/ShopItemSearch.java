...
public class ShopItemSearch extends AppCompatActivity {
    ...
    private void init() {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ServiceShopItemSearch(inputSearch.getText().toString(), new SharedPrefDatabase(getApplicationContext()).RetriveUserShopvendor());
            }
        });
    ...
    public void ServiceShopItemSearch(final String service_shop_search, final String item_vendor){
        progressBar.setVisibility(View.VISIBLE);
        itemListArrayList.clear();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiURL.Service_Shop_Item_Search,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("service_shop_search", service_shop_search);
