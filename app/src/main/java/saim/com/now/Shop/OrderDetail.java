...
public class OrderDetail extends AppCompatActivity {
    ...
    public void showPlaceOrderDialog(final String id) {
        ...
        final View dialogView = inflater.inflate(R.layout.dialog_shop_placeorder_complete, null);
        ...
        dialogBuilder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                PlaceOrderFinal(id, txtDMessage.getText().toString());
            }
        });
    ...
    public void PlaceOrderFinal(final String id, final String order_user_message){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiURL.Service_Shop_Order_Complete,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("id", id);
                params.put("order_user_message", order_user_message);
