...
/**
 * Created by NREL on 2/11/18.
 */

public class ModelShopCatMenu {
    public String id, service_shop_ic_id, service_shop_ic_name, service_shop_ic_icon, service_shop_ic_color, service_shop_id;

    public ModelShopCatMenu(String id, String service_shop_ic_id, String service_shop_ic_name, String service_shop_ic_icon, String service_shop_ic_color, String service_shop_id) {
        this.id = id;
